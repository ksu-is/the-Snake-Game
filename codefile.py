...
window.bind('<Left>', lambda event: change_dic('left'))
window.bind('<Right>', lambda event: change_dic('right'))
window.bind('<Up>', lambda event: change_dic('up'))
window.bind('<Down>', lambda event: change_dic('down'))
